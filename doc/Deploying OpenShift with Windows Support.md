...
2. Clone the [openshift.net](https://github.com/Click2Cloud/openshift-dotnet-installer) repo

		git clone git@github.com:Click2Cloud/openshift-dotnet-installer.git 
...
4. Change directory to your openshift-dotnet-installer clone
5. Run the following commands:

		build
		powershell -file package.ps1 package
6. Done. You should have an installer `click2cloud-openshift-winnode.exe` in your openshift.net clone dir.
...
**PARAMETERS**
    ...
    -containerizationPlugin <String>
        ...
        Required?                    no
        Default value                Click2Cloud-prison
