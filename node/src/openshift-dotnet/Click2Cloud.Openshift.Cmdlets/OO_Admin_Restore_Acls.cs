...
using Click2Cloud.OpenShift.TrapUser;
            ...
            {                
                ...
                {                  
                  ...
                  switch (instancefolderinfo[0]) {
                      case "MSSQL12": { Prison.MsSqlInstanceTool.ConfigureMsSqlInstanceRegistry(prison, instancefolderinfo[0], "MSSQLSERVER2014"); break; }
