...
namespace Click2Cloud.Openshift.Runtime
{
    public class CartridgeModel
    {
        ...
        {
            // TODO: RGen: complete implementation of this method
        ...
        private string PopulateGearRepo(string cartName, string softwareVersion, string templateGitUrl)
        {
            ...
            // TODO (RGen): make sure there isn't a more elegant way to deal with SQL Server Instances
            if (cartName == "mssql" && softwareVersion == "2008")
            {
                Click2Cloud.Prison.MsSqlInstanceTool.ConfigureMsSqlInstanceRegistry(prison, "MSSQL10_50", "MSSQLSERVER");
            ...
            {
                Click2Cloud.Prison.MsSqlInstanceTool.ConfigureMsSqlInstanceRegistry(prison, "MSSQL11", "MSSQLSERVER2012");
            ...
            else if (cartName == "mssql" && softwareVersion == "2014")
            {
                Click2Cloud.Prison.MsSqlInstanceTool.ConfigureMsSqlInstanceRegistry(prison, "MSSQL12", "MSSQLSERVER2014");
                CreateSQLServerInstanceDatabases(cartName, prison, "MSSQL12", "MSSQLSERVER2014");
                ChangeConfigControl(cartName, softwareVersion, "MSSQL12");
            }
