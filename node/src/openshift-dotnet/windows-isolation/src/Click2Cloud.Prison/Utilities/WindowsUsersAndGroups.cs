// -----------------------------------------------------------------------
// <copyright file="WindowsUsersAndGroups.cs" company="RGen Solutions">
// Copyright (c) 2015 RGen Solutions, All Rights Reserved
// </copyright>
// -----------------------------------------------------------------------

namespace Click2Cloud.Prison.Utilities
{
    using System;
    ...
    public static class WindowsUsersAndGroups
    {
        ...
        {
            CreateUser(userName, password, string.Format("User '{0}' was created by the RGen Prison.", userName));
        }
