...
using Click2Cloud.Prison.Restrictions;
using Click2Cloud.Prison.Utilities;
using Click2Cloud.Prison.Utilities.WindowsJobObjects;

namespace Click2Cloud.Prison
{
    [DataContract]
    public class Prison
    {
        ...
        public const string changeSessionBaseEndpointAddress = @"net.pipe://localhost/Click2Cloud.Prison.ExecutorService/Executor";

        private const string databaseLocation = @".\RGen-prison-db";
        ...
        private static string GetCreateProcessDeletegatePath()
        {
            ...
            return Path.Combine(assemblyDirPath, "Click2Cloud.Prison.CreateProcessDelegate.exe");
        }
        ...
        private static string GetGuardPath()
        {
            ...
            return Path.Combine(assemblyDirPath, "Click2Cloud.Prison.Guard.exe");
        }
        ...
        private static string GetChangeSessionServicePath()
        {
            ...
            return Path.Combine(assemblyDirPath, "Click2Cloud.Prison.ChangeSession.exe");
        }
