...
using Click2Cloud.Openshift.Runtime.Fakes;
using System.Diagnostics;
using Click2Cloud.Prison.Fakes;
using Click2Cloud.Openshift.Common.Utils;
using Click2Cloud.Openshift.Runtime.Model.ApplicationContainerExt;
                ...
                using (ShimsContext.Create())
                {
                    ...
                    container.CreateString = new FakesDelegates.Func<string, string>((string a) =>
                    {
                        ...
                        containerPlugin.Create = new FakesDelegates.Action(() =>
                        {
                            ...
                            ShimPrison prison = new ShimPrison(new Click2Cloud.Prison.Prison(prisonGuid));
                            prison.Instance.Tag = "oo";

                            Click2Cloud.Prison.PrisonRules prisonRules = new Click2Cloud.Prison.PrisonRules();
                            ...
                            // TODO: RGen: make sure these limits are ok being the same
                            ...
                            prison.LockdownPrisonRules = new FakesDelegates.Action<Prison.PrisonRules>((Click2Cloud.Prison.PrisonRules rules) => {                                
                    ...
                    Click2Cloud.Openshift.Runtime.Model.GearRegistry reg = container.Instance.GearRegist;
